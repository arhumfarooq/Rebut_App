...
final String Date;
  ...
  const CheckoutContainer({super.key, required this.productImage, required this.productName, required this.productPrice, required this.Date});
          ...
          Expanded(
            child: Padding(
              ...
              color: Color(0xff616161)
                  ...
                  SizedBox(height: 4,),
              Text(Date,style: GoogleFonts.firaSans(
                    fontSize: 18,
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      color: Color(0xff616161)
                        ...
                        MyContainerWidget2(title: "Remove")
                    ],
                  )
